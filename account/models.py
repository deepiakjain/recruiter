...
class EducationBackground(models.Model):
    ...
    year_of_passing = models.CharField(max_length=4, null=True, default='None')
    percentage = models.CharField(max_length=5, null=True, default='None')
...
class JobSeeker(BaseProfile):
    ...
    skill_set = models.TextField(null=True, default='None', help_text="Comma-separated technologies")
    ...
    # preferred locations.
    preferred_loc = models.CharField(max_length=30, default='None', help_text="Comma-separated cities name")
